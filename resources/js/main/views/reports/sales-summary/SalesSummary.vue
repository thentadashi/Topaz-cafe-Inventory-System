...
export default defineComponent({
  ...
  printTable() {
    ...
    // Add custom print styles to hide pagination buttons
    const printStyles = `
      <style>
        @media print {
          .table-responsive .ant-pagination .ant-table-pagination {
	...
	setup(props) {
		...
		const getData = (propsData) => {
			...
			datatableVariables.table.sorter = { field: "order_date", order: "asc" };
