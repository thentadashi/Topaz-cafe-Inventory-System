...
const fields = () => {
	...
	const url = "warehouses?fields=id,xid,logo,logo_url,dark_logo,dark_logo_url,name,slug,email,phone,address,show_email_on_invoice,show_phone_on_invoice,terms_condition,bank_details,signature,signature_url";
	const { t } = useI18n();
