...
class Company extends BaseModel
{
	...
	protected $appends = ['xid', 'x_currency_id', 'x_warehouse_id', 'login_image_url', 'light_logo_url', 'dark_logo_url', 'small_light_logo_url', 'small_dark_logo_url', 'beep_audio_url'];
